...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener, VideoRecycleViewAdapter.RowItemsListener {
...
//                        .setTheme(R.style.AppTheme_Purple)
    ...
    public void onRowItemSelected(RowItem rowItem, ImageView sharedImageView) {
        ...
        if(isVideoValid(rowItem.getFile().getAbsoluteFile().toString())){
                ...
                Intent i = new Intent(MainActivity.this, VideoViewer.class);
